...
const int32_t Operator::s_pseudo_plan_node_id_for_result_sink = -1;
const int32_t Operator::s_pseudo_plan_node_id_for_olap_table_sink = -2;
const int32_t Operator::s_pseudo_plan_node_id_for_export_sink = -3;
const int32_t Operator::s_pseudo_plan_node_id_for_memory_scratch_sink = -4;
const int32_t Operator::s_pseudo_plan_node_id_for_iceberg_table_sink = -5;

std::set<int32_t> Operator::s_final_sink_pseudo_plan_node_ids = {
        s_pseudo_plan_node_id_for_result_sink, s_pseudo_plan_node_id_for_olap_table_sink,
        s_pseudo_plan_node_id_for_export_sink, s_pseudo_plan_node_id_for_memory_scratch_sink,
        s_pseudo_plan_node_id_for_iceberg_table_sink};

const int32_t Operator::s_pseudo_plan_node_id_for_multi_cast_sink = -100;
...
Operator::Operator(OperatorFactory* factory, int32_t id, std::string name, int32_t plan_node_id, bool is_subordinate,
    ...
    if (s_final_sink_pseudo_plan_node_ids.find(_plan_node_id) != s_final_sink_pseudo_plan_node_ids.end()) {
        _unique_metrics->add_info_string("IsFinalSink", "True");
    }
    if (is_subordinate) {
        _unique_metrics->add_info_string("IsSubordinate", "True");
    }
}
